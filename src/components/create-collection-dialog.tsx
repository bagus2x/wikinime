...
export interface CreateCollectionDialogProps {
  open?: boolean
  onCancel?: () => void
  onSave?: (newCollectionName: string) => void
}

export default function CreateCollectionDialog({ onSave, onCancel, open }: CreateCollectionDialogProps) {
      ...
      <Dialog.Portal>
        ...
        <DialogContent>
          ...
          <div style={{ display: 'flex', marginTop: 25, justifyContent: 'flex-end' }}>
            ...
            <SaveButton
              onClick={() => {
                onSave && onSave(newCollectionName)
